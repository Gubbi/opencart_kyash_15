...
2. Upload the contents of [opencart_kyash_15.zip](https://github.com/Gubbi/opencart_kyash_15/releases/download/v1.6/opencart_kyash_15-1.6.zip) file as it is to OpenCart.
