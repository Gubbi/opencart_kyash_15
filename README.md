...
2. Upload the contents of [opencart_kyash_15.zip](https://github.com/Gubbi/opencart_kyash_15/releases/download/v1.4/opencart_kyash_15-1.4.zip) file as it is to OpenCart.
